...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'statusFields', '1', 'Status', 'Status', 
    'Status', 'VARCHAR', 'STATUS', NULL, NULL, 
    '0', '0', NULL, 'TEXTBOX', NULL, 
    'Y', NULL, NULL);
Insert into PANEL_FIELDS
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'panelFields', '1', 'PO ID', 'poid', 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'panelFields', '2', 'RRF ID', 'porrfid', 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'panelFields', '3', 'PO Date', 'podate', 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'panelFields', '4', 'Status', 'postatus', 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'statusFields', '2', 'Wfl ActionID', 'wflactionid', 
    'wflactionid', 'NUMBER', 'WFLACTIONID', NULL, NULL, 
    '0', '1', NULL, 'TEXTBOX', NULL, 
    'Y', NULL, NULL);
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'panelFields', '5', 'Comments', 'pocomments', 
    'pocomments', 'VARCHAR', 'PO_COMMENTS', NULL, NULL, 
    '2', '0', NULL, 'TEXTAREA', NULL, 
    NULL, NULL, NULL);
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'buttonPanel', '1', 'Delete PO', 'delete', 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'statusFields', '3', 'Wfl Action Desc', 'wflactiondesc', 
    'wflactiondesc', 'VARCHAR', 'WFLACTIONDESC', NULL, NULL, 
    '1', '0', NULL, 'TEXTBOX', NULL, 
    'Y', NULL, NULL);
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'statusFields', '4', 'Wfl ID', 'wflid', 
    'wflid', 'VARCHAR', 'WFLID', NULL, NULL, 
    '1', '1', NULL, 'TEXTBOX', NULL, 
    'Y', NULL, NULL);
Insert into PANEL_FIELDS
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmPO', 'buttonPanel', '2', 'Back To List', 'btnback', 
    'btnback', NULL, NULL, ' onclick="backToList();"', NULL, 
    '1', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, NULL);
Insert into PANEL_FIELDS
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '1', 'Save', 'btnSave', 
    'btnSave', ' ', ' ', ' onclick=''reqSave();''', NULL, 
    '0', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, NULL);
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '2', 'Submit', 'btnsubmit', 
    'btnsubmit', NULL, NULL, 'onclick=''submitScreenFlowactivity()''', NULL, 
    '2', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '3', 'Delete', 'btndelete', 
    'btndelete', NULL, NULL, 'onclick=''deleteData();''', NULL, 
    '3', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '4', 'Modify', 'btnmodify', 
    'btnmodify', NULL, NULL, 'onclick=''enable_fields();''', NULL, 
    '1', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '5', 'Cancel', 'btncancel', 
    'btncancel', NULL, NULL, NULL, NULL, 
    '4', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '6', 'Close', 'btnclose', 
    'btnclose', NULL, NULL, NULL, NULL, 
    '5', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
...
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
    ...
    PRKEY, AUTOGEN, ELEM_ATTRIB)
 Values
   ('frmRequest', 'buttonPanel', '7', 'Update', 'btnupdate', 
    'btnupdate', NULL, NULL, 'onclick=''reqSave();''', NULL, 
    '6', '0', NULL, 'BUTTON', NULL, 
    NULL, NULL, 'disabled="disabled"');
Insert into PANEL_FIELDS
   (SCR_NAME, PANEL_NAME, ORDERNO, LBLNAME, FNAME, 
